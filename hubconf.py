...
def mobilenetv3(pretrained: bool = True, progress: bool = True):
    ...
    if pretrained:
        url = 'https://github.com/DongMaicle/RobustVideoMatting/releases/download/v1.0.0/rvm_mobilenetv3.pth'
...
def resnet50(pretrained: bool = True, progress: bool = True):
    ...
    if pretrained:
        url = 'https://github.com/DongMaicle/RobustVideoMatting/releases/download/v1.0.0/rvm_resnet50.pth'
        model.load_state_dict(torch.hub.load_state_dict_from_url(url, map_location='cpu', progress=progress))
    return model
